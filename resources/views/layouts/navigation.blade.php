<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/restaurant-logo.png" class="h-8 object-contain" alt="Restaurant Logo" width="83">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Restaurants Button -->
                    <x-nav-link :href="route('restaurant.index')" :active="request()->routeIs('restaurant.*')">
                        المطاعم
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('restaurant.index')" :active="request()->routeIs('restaurant.*')">
                المطاعم
            </x-responsive-nav-link>
        </div>
